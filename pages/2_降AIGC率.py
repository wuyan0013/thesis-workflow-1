...
st.markdown("""<div style="margin: 1rem 0 2rem 0;">
    <span style="background: rgba(245,158,11,0.12); border: 1px solid rgba(245,158,11,0.25); border-radius: 24px; padding: 10px 24px; color: #F59E0B; font-size: 1rem; font-weight: 500;">🤖 降AIGC率</span>
    <h1 style="font-size: 2.5rem; font-weight: 800; color: #FFFFFF; margin: 1.5rem 0 0.5rem 0;">智能人格化改写</h1>
    <p style="color: #9CA3AF; font-size: 1.1rem; margin: 0;">通过人格化改写降低AI检测率，适用于<span style="color: #F59E0B; font-weight: 600;">ZeroGPT、GPTZero</span>等检测工具</p>
...
st.markdown("""<div style="display: flex; justify-content: space-between; padding: 1rem 0;">
    <span style="color: #52525B; font-size: 0.85rem;">处理结果仅供参考，请在提交前进行人工审核</span>
